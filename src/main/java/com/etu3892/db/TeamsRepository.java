...
public class TeamsRepository {
    ...
    public List getNnStTeams() throws SQLException {
        ...
        while (rs1.next()) {
            Team team = new Team(rs1.getInt("teamId"),rs1.getString("team"), SportsRepository.getById(rs1.getInt("sportId")), CountriesRepository.getCountryById(rs1.getInt("countryId")));
            teamsList.add(team);
        }
    ...
    public static Team getTeamById(int id) throws SQLException {
        ...
        ResultSet rs1 = DBConnector.getSet(tryquery);
        rs1.next();
        return new Team(rs1.getInt("teamId"),rs1.getString("team"), SportsRepository.getById(rs1.getInt("sportId")), CountriesRepository.getCountryById(rs1.getInt("countryId")));
    }
