    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (type){
            case 0:
                ...
                CountriesRepository.removeCountry(country);
                break;
            case 1:
                ...
                break;
            case 2:
                League league = new League(Integer.parseInt(request.getParameter("id")),"",0,0);
                LeaguesRepository.removeLeague(league);
                break;
            case 3:
                Team team = new Team(Integer.parseInt(request.getParameter("id")));
                TeamsRepository.removeTeam(team);
                break;
        }
